...
`SDD/Adapters/Api-rest-endpoints.md`.
...
defined in `SDD/Adapters/Global-exception-handler.md`. Domain business rules
(balance, eligibility, approval authority) are NOT part of this document; they
belong to `SDD/Domain/services/`.
...
`SDD/Adapters/Global-exception-handler.md` for the uniform response shape.
