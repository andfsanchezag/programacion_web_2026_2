...
export default defineConfig({
  test: {
    ...
    coverage: {
      ...
      exclude: [
        'src/application/domain/index.ts',
        'src/application/domain/ports/**',
        'src/application/server.ts',
        'src/application/infrastructure/database/**',
        'src/application/adapters/rest/dtos/dtos.ts',
        'src/application/adapters/persistence/typeorm/entities/entities.ts',
        'src/application/adapters/persistence/mongoose/documents/AuditLogDocument.ts',
      ],
    },
  },
});