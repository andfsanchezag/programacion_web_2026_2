...
import { InvalidTransferException } from '../../src/application/domain/exceptions/transfer-errors';
import { TransferAlreadyApprovedException } from '../../src/application/domain/exceptions/transfer-errors';
import { UnauthorizedApprovalException } from '../../src/application/domain/exceptions/authorization-errors';
import { InvalidCredentialsException } from '../../src/application/domain/exceptions/user-errors';
...
describe('Global Exception Handler: clasificación determinística', () => {
  ...
  it('409 para violaciones de estado (StatusException)', async () => {
    const { InvalidLoanStatusException } = await import('../../src/application/domain/exceptions/loan-errors');
